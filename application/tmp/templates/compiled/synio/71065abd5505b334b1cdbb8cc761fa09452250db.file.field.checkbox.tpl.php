<?php /* Smarty version Smarty-3.1.13, created on 2019-08-05 09:38:16
         compiled from "/var/www/sait.livestreet.com/framework/frontend/components/field/field.checkbox.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8414216085d47ced8becc18-68487249%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '71065abd5505b334b1cdbb8cc761fa09452250db' => 
    array (
      0 => '/var/www/sait.livestreet.com/framework/frontend/components/field/field.checkbox.tpl',
      1 => 1493617438,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '8414216085d47ced8becc18-68487249',
  'function' => 
  array (
  ...
  'unifunc' => 'content_5d47ced8c11c63_29220443',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d47ced8c11c63_29220443')) {function content_5d47ced8c11c63_29220443($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include '/var/www/sait.livestreet.com/framework/classes/modules/viewer/plugs/function.component_define_params.php';
...
<?php }?>
    ...
    <?php echo smarty_function_component_define_params(array('params'=>array('checked')),$_smarty_tpl);?>

    <?php $_smarty_tpl->tpl_vars['mods'] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['mods']->value)." checkbox", null, 0);?>
    <?php $_smarty_tpl->tpl_vars['getValueFromForm'] = new Smarty_variable(false, null, 0);?>
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['value'] = new Smarty_variable((($tmp = @$_tmp1)===null||$tmp==='' ? $_smarty_tpl->tpl_vars['value']->value : $tmp), null, 0);?>
    ...
    <?php $_smarty_tpl->tpl_vars['value'] = new Smarty_variable($_smarty_tpl->tpl_vars['value']->value ? $_smarty_tpl->tpl_vars['value']->value : '1', null, 0);?>
...
-holder">
    ...
    <?php if (!isset($_smarty_tpl->tpl_vars['checked']->value)&&$_smarty_tpl->tpl_vars['name']->value&&$_smarty_tpl->tpl_vars['form']->value){?>
        <?php echo smarty_function_field_get_value(array('form'=>$_smarty_tpl->tpl_vars['form']->value,'name'=>$_smarty_tpl->tpl_vars['name']->value,'assign'=>'formValue'),$_smarty_tpl);?>


        <?php if (is_array($_smarty_tpl->tpl_vars['formValue']->value)){?>
            <?php $_smarty_tpl->tpl_vars['checked'] = new Smarty_variable(in_array($_smarty_tpl->tpl_vars['value']->value,$_smarty_tpl->tpl_vars['formValue']->value), null, 0);?>
        <?php }else{ ?>
            <?php $_smarty_tpl->tpl_vars['checked'] = new Smarty_variable($_smarty_tpl->tpl_vars['value']->value==$_smarty_tpl->tpl_vars['formValue']->value, null, 0);?>
        <?php }?>
    <?php }?>
