<?php /* Smarty version Smarty-3.1.13, created on 2019-08-05 11:49:57
         compiled from "/var/www/sait.livestreet.com/application/frontend/skin/synio/actions/ActionError/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9037338765d47bf2054f5e5-81803236%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c2cd14534fffabfb73c8f0df1abc8e0a198d6e6f' => 
    array (
      0 => '/var/www/sait.livestreet.com/application/frontend/skin/synio/actions/ActionError/index.tpl',
      1 => 1493617408,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '9037338765d47bf2054f5e5-81803236',
  'function' => 
  array (
    'layout_footer_links' => 
    array (
  ...
  'unifunc' => 'content_5d47bf205aa841_55162213',
  'variables' => 
  array (
    'lang' => 0,
    'rtl' => 0,
...
<?php if ($_valid && !is_callable('content_5d47bf205aa841_55162213')) {function content_5d47bf205aa841_55162213($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include '/var/www/sait.livestreet.com/framework/classes/modules/viewer/plugs/function.component_define_params.php';
...
<?php echo smarty_function_component_define_params(array('params'=>array('mods','classes','attributes')),$_smarty_tpl);?>
    ...
    <?php $_smarty_tpl->tpl_vars['layoutShowSystemMessages'] = new Smarty_variable(false, null, 0);?>
...
">
    ...
    <?php if ($_smarty_tpl->tpl_vars['aMsgError']->value[0]['title']){?>
        <?php echo $_smarty_tpl->tpl_vars['aLang']->value['common']['error']['error'];?>
...
?>
    ...
    <p>
        <a href="javascript:history.go(-1);"><?php echo $_smarty_tpl->tpl_vars['aLang']->value['common']['site_history_back'];?>
</a>,
        <a href="<?php echo smarty_function_router(array('page'=>'/'),$_smarty_tpl);?>
"><?php echo $_smarty_tpl->tpl_vars['aLang']->value['common']['site_go_main'];?>
</a>
    </p>
