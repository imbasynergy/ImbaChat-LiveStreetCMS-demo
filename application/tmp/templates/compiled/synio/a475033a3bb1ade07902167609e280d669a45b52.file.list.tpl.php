<?php /* Smarty version Smarty-3.1.13, created on 2019-08-05 09:39:15
         compiled from "/var/www/sait.livestreet.com/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/users/list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8966958585d47cf13cbe7e0-75994689%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a475033a3bb1ade07902167609e280d669a45b52' => 
    array (
      0 => '/var/www/sait.livestreet.com/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/users/list.tpl',
      1 => 1493617528,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '8966958585d47cf13cbe7e0-75994689',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d47cf13cfb979_89653957',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d47cf13cfb979_89653957')) {function content_5d47cf13cfb979_89653957($_smarty_tpl) {?><?php if (!is_callable('smarty_function_router')) include '/var/www/sait.livestreet.com/framework/classes/modules/viewer/plugs/function.router.php';
...
<div id="container" class=" <?php if ($_smarty_tpl->tpl_vars['bNoSidebar']->value){?>no-sidebar<?php }?>">
	...
	<?php echo smarty_function_component(array('_default_short'=>'admin:p-user.search','queries'=>$_smarty_tpl->tpl_vars['aSearchRulesWithOriginalQueries']->value,'action'=>$_smarty_tpl->tpl_vars['sFullPagePathToEvent']->value),$_smarty_tpl);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
	...
	<?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['users']['title'];?>
 <span>(<?php echo $_smarty_tpl->tpl_vars['iUsersTotalCount']->value;?>
)</span>
</h2>
	...
	<?php echo smarty_function_component(array('_default_short'=>'admin:p-user','template'=>'list','users'=>$_smarty_tpl->tpl_vars['aUsers']->value,'pagination'=>$_smarty_tpl->tpl_vars['aPaging']->value),$_smarty_tpl);?>
